...
var ASM_CONSTS = {
 7092768: ($0, $1, $2) => {
  ...
  var data = new Uint8Array(GROWABLE_HEAP_U8().buffer, $1, $2).slice();
 ...
 7095641: () => globalThis._importedSaveData ? 1 : 0,
 7095690: () => globalThis._importedSaveData ? globalThis._importedSaveData.length : 0,
 7095773: ($0, $1) => {
  var data = globalThis._importedSaveData;
  if (data) {
   var len = Math.min(data.length, $1);
   GROWABLE_HEAP_U8().set(data.subarray(0, len), $0);
   globalThis._importedSaveData = null;
  }
 },
 7095945: () => {
 ...
 7096889: () => Module["SDL3"].audioContext.sampleRate,
 7096940: ($0, $1, $2, $3) => {
  var SDL3 = Module["SDL3"];
 ...
 7102494: () => (navigator.mediaDevices === undefined) ? 0 : 1,
 7102553: ($0, $1, $2, $3, $4, $5, $6) => {
  const device = $0;
  const w = $1;
  const h = $2;
 ...
 7113748: () => window.innerWidth,
 7113778: () => window.innerHeight,
 7113809: $0 => {
...
var ___pthread_create_js = (pthread_ptr, attr, startRoutine, arg) => {
 ...
 var offscreenCanvases={};if(globalThis.window&&!window.TRANSFERRED_CANVAS){Module["canvas"]=document.getElementById("canvas");transferredCanvasNames=["#canvas"];window.TRANSFERRED_CANVAS=true;}
...
function _emscripten_webgl_create_context_proxied(target, attributes) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(43, 0, 1, target, attributes);
